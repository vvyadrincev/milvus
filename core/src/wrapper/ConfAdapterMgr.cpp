...
AdapterMgr::RegisterAdapter() {
    ...
    REGISTER_CONF_ADAPTER(ConfAdapter, IndexType::FAISS_GPU_FLAT_FP16, gpu_flat_fp16);
    ...
    REGISTER_CONF_ADAPTER(IVFConfAdapter, IndexType::FAISS_GPU_IVF_FP16, ivf_gpu_fp16);
