...
-DKNOWHERE_GPU_VERSION=${GPU_VERSION} \
-DFAISS_WITH_MKL=${WITH_MKL} \
-DMILVUS_WITH_PROMETHEUS=${WITH_PROMETHEUS} \
-DMILVUS_WITH_FIU=${FIU_ENABLE} \
-DCMAKE_EXPORT_COMPILE_COMMANDS=ON \
-DMILVUS_WITH_MYSQLPP=ON \
-DMILVUS_ENABLE_PROFILING=OFF \
-DMILVUS_WITH_GRPC=OFF \
-DMILVUS_WITH_PROMETHEUS=OFF \
-DMILVUS_WITH_YAMLCPP=OFF \
-DMILVUS_WITH_EASYLOGGINGPP=OFF \
-DMILVUS_WITH_SQLITE=OFF \
-DMILVUS_WITH_ZLIB=OFF \
-DMILVUS_WITH_OPENTRACING=OFF \
-DMILVUS_WITH_AWS=OFF
../"
echo ${CMAKE_CMD}
${CMAKE_CMD}
