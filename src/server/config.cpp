...
static const std::unordered_map<std::string, std::string> milvus_config_version_map({{"0.1", "0.1"}});
...
Config::CheckConfigVersion(const std::string& value) {
    if (! milvus_config_version_map.contains(MILVUS_VERSION)) {
        std::string msg = "MILVUS_VERSION " + std::string(MILVUS_VERSION) + " not in map!";
